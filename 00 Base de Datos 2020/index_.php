...
$panel_Content->addState("", "content/hoy.php", ".::SIGAPO::CORRESPONDENCIA 2013", "", "");
...
function postales(){
     new Widgets.Dialog('SIGAPO 2009::', 'content/postales/pub_spot.php', { click_outside: true, width: 525, height: 475 });
...
function nit(){
 ...
 function intro(){
     new Widgets.Dialog('SIGAPO 2010:: MENSAJE', 'content/postales/intro3.php', { click_outside: true, width: 525, height: 440 });
...
<!--<body onload="usuario();usuarios_online();nit();" style="background:url(img/bgpanel.png);">-->
