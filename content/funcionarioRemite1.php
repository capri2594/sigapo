...
?>
          <tr class="filter">
            ...
            <th><input type="text" name="dtable_DWAjaxTable1_nombredep" value="<?php echo KT_escapeAttribute($dtable_DWAjaxTable1->getFilterValue('nombredep')); 
			 //echo $_GET[nomdep];?>" size="20" maxlength="20" style="visibility:hidden"/></th>
