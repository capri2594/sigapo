<?php
<object class="UScrollBar" name="uScrollBar" baseclass="page">
  <property name="Background"></property>
  <property name="Caption">ScrollBar Demo</property>
  ...
  <property name="Name">uScrollBar</property>
  <property name="Width">1120</property>
  ...
  <object class="Button" name="Button1" >
    <property name="Caption">Set Position to 200</property>
    <property name="Font">
        <property name="Align">taNone</property>
        <property name="Case"></property>
        <property name="Color"></property>
  ...
  <object class="ScrollBar" name="ScrollBar1" >
    <property name="Height">17</property>
    <property name="Left">19</property>
    <property name="Name">ScrollBar1</property>
