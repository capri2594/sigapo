...
<object class="Index" name="Index" baseclass="page">
  ...
  <property name="Caption">Unit181</property>
  ...
  <property name="Width">904</property>
  ...
  <object class="Edit" name="Edit1" >
    ...
    <property name="Text">English Text</property>
  ...
  <object class="Button" name="Button1" >
    <property name="Caption">Change to Spanish</property>
    <property name="Font">
        <property name="Align">taNone</property>
        <property name="Case"></property>
        <property name="Color"></property>
  ...
  <object class="Button" name="Button2" >
    <property name="Caption">Change Label to some text</property>
    <property name="Font">
        <property name="Align">taNone</property>
        <property name="Case"></property>
        <property name="Color"></property>
