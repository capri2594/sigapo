...
*/
   ...
   registerAsset(array("Page"),array("js","xajax"));
   ...
   registerAsset(array("BitBtn","StringGrid"),array("qooxdoo"));
   ...
   registerPropertyValues("FocusControl","Layout.Type",array('ABS_XY_LAYOUT','XY_LAYOUT','FLOW_LAYOUT', 'GRIDBAG_LAYOUT', 'ROW_LAYOUT', 'COL_LAYOUT'));
   ...
   registerPropertyValues("Frame","Borders",array('0','1'));
