      ...
      <tr>
        <td><p align="center" class="Estilo13"><img src="../img/iconos/insertar.gif" width="40" height="40" />&nbsp;Ingresar el codigo de la hoja de ruta.</p>
          <table width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr>
              <td width="24%" align="right" valign="middle"><?php echo $_SESSION['cod_dep']; ?>&nbsp;&nbsp;</td>
            ...
            <td><table width="100%" border="0" cellspacing="1" cellpadding="7">
              <tr>
                <td><div class="cuadro">
                  ...
                  Remitente:&nbsp;<span id="sprytextfield6"><span class="textfieldRequiredMsg">Se necesita un valor</span></span><span class="subrayadoCampo"><?php echo $_SESSION['fun']; ?>&nbsp;&nbsp;&lt;<em><?php echo $_SESSION['dep']; ?></em>&gt;</span><br />
                  <br />
                  ...
                  <input name="destinatario" type="text" class="subrayadoCampo" id="destinatario" size="30" readonly="readonly" width="100px"/>
