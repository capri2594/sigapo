...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
  <tr>
    ...
    <td><?php if ($msgExito){?>
        ...
        <div align="right"><?php echo $_POST['cite']; ?>-<?php echo $row_reg_Internos['cite']; ?>
  ...
  <tr>
    ...
    <td><table width="300" border="0" cellspacing="5" cellpadding="0">
          <tr>
            ...
            <td><input type="submit" name="button2" id="button2" value="Vista Impresion" /></td>
            <td><input type="button" name="button4" id="button4" onclick="if(confirm('¿Esta seguro de cancelar la operacion?')){MM_goToURL('self','RecibirInternos1.php');return document.MM_returnValue;}" value="cancelar" /></td>
          </tr>
      </table></td>
    <td>&nbsp;</td>
  </tr>
