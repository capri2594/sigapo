    ...
    <table width="100%" border="0" cellspacing="5" cellpadding="0">
          ...
          <tr>
            ...
            <td><span id="sprytextfield1"><span id="sprytextfield8">
              <input type="text" name="hojaruta" id="hojaruta" />
          ...
          <tr>
            <td><div align="right" class="Estilo2">Hojas:&nbsp;</div></td>
            <td><span id="sprytextfield11">
            <input type="text" name="hojas" id="hojas" />
            <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldInvalidFormatMsg">Formato no válido.</span></span></td>
          </tr>
          <tr>
            <td valign="top"><div align="right" class="Estilo2">Anexos:&nbsp;</div></td>
            <td><span id="sprytextarea1">
              <textarea name="anexos" id="anexos" cols="65" rows="5"></textarea>
