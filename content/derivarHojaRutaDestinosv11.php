          ...
          <?php $i=1; //indice de fechas.... por destinos?>
            ...
            <tr class="celdas">
              ...
              <td width="70"><?php if ($row_listar_destinos['entradas_id']>0){ ?>
                ...
                <?php }?></td>
              <td width="100"><div align="left" class="fech_salida" id="sal<?php echo $i; ?>"><?php //echo cambiar_a_normal_letra_con_hora($row_listar_destinos['fecha_derivacion']); ?>
              <?php //cambiar_a_normal_letra_con_hora($listafechas[$i-1]); ?><?php if($i==$totalRows_listar_destinos){?>
              <img src="imagen/help.png" alt="no" width="26" height="30" longdesc="no" /><?php }?></div>
                  <script>
              ...
              <td width="95"><?php if ($row_listar_destinos['entradas_id']>0){ ?><img src="imagen/conformidad_accept.gif" alt="si" width="16" height="16" longdesc="si" />
                ...
                <?php }else{?><img src="imagen/conformidad_error.gif" alt="no" width="16" height="16" longdesc="no" /> <span class="pendiente"> Incorrectamente
                </span><?php }?>          <br />
