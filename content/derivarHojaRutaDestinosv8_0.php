      ...
      <tr bgcolor="#EDEFF3">
        ...
        <td width="70" height="25">Estado</td>
          ...
          <tr class="celdas">
            ...
            <td width="70"><?php echo $row_obtener_hr['fecha_creacion']; ?><?php   
			$Fecha=$row_obtener_hr['fecha_creacion'];
			$Anio=$Fecha["year"];
  $Mes=$Fecha["mon"];
  $Dia=$Fecha["mday"];
  $Hora=$Fecha["hours"].":".$Fecha["minutes"].":".$Fecha["seconds"]; 
  echo "$Mes"; ?></td>
            <td width="40"><?php echo "0 dias" ?>&nbsp;</td>
            <td width="100">&nbsp;</td>
          ...
          <?php if ($totalRows_listar_destinos > 0) { // Show if recordset not empty ?>
            ...
            <tr class="celdas">
              ...
              <td width="100"><?php echo "0 dias" ?></td>
