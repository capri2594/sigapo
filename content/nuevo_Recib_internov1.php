...
<form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST">
  <table width="100%" border="0">
    <tr>
      <td>  <?php if ($error_repetido){ ?><div class="error" id="error" style="width:400px;"><?php echo $error_repetido; ?></div>
       	<script type="text/javascript">
...
paramName: "nombre"});
                ...
                <td height="30">
                  ...
                  <input name="seg_d_destino" type="text" id="seg_d_destino" size="35" /></label>
                  <span class="textfieldRequiredMsg">X</span></span>
                  <script type="text/javascript">
...
?>
            ...
            <table width="100%" border="0">
              ...
              <tr>
                ...
                <td><span id="sprytextfield4">
                  <input name="cite" type="text" id="cite" size="60" />
    ...
    function conMayusculas(field) {
            field.value = field.value.toUpperCase()
                ...
                <input name="ref" type="text" id="ref" size="60" onChange="conMayusculas(this)"/>
                <span class="textfieldRequiredMsg">X.</span><span class="textfieldMinCharsMsg">(+)caracter..</span></span></td>
                </tr>
              <tr>
                <td>Hojas</td>
                <td><span id="sprytextfield6">
                <input name="nhojas" type="text" id="nhojas" size="60" maxlength="5" />
