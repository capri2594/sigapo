...
/*$hoy_listaRecibidos = "-1";
if (isset(hoy)) {
  $hoy_listaRecibidos = hoy;
}*/
mysql_select_db($database_snet, $snet);
$query_listaRecibidos = sprintf("SELECT entradas. *,einterna.* FROM entradas, einterna WHERE entradas.fecha_recibido>%s AND einterna.entradas_id=entradas.id ORDER BY fecha_recibido DESC", GetSQLValueString($hoy_listaRecibidos, "date"));
$listaRecibidos = mysql_query($query_listaRecibidos, $snet) or die(mysql_error());
$row_listaRecibidos = mysql_fetch_assoc($listaRecibidos);
$totalRows_listaRecibidos = mysql_num_rows($listaRecibidos);
        ...
        <tr <?php if (($i%2)==0) echo "class=\"par\""; else echo "class=\"impar\"";?>>
          ...
          <td>          
            <table width="100%" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td><div style="border-style:solid; border:1px; margin:2px; padding:3px;">
                <strong>cite:</strong><em>&nbsp;<?php echo $row_listaRecibidos['cite']; ?> <span class="Estilo2">(<?php echo $row_listaRecibidos['fecha_proveido']; ?>)&nbsp;</span></em><strong>&nbsp;referencia: </strong><em><?php echo $row_listaRecibidos['ref']; ?></em><strong>&nbsp;hojas</strong>:<em><?php echo $row_listaRecibidos['nhojas']; ?></em> <strong>adjuntos</strong>:<span class="Estilo2"><em><?php echo $row_listaRecibidos['adjuntos']; ?></em></span> <strong>anexos</strong>:<span class="Estilo2"><em><?php echo $row_listaRecibidos['anexos']; ?></em></span> &nbsp;:::: <strong>Firmo el</strong><strong>proveido</strong>:<em><?php echo $row_listaRecibidos['fun_proveido']; ?></em> en ::<strong>fecha:</strong><em><?php echo $row_listaRecibidos['fecha_proveido']; ?></em></div></td>
              </tr>
              <tr>
                <td><strong>de:</strong><em>&nbsp;<?php echo $row_listaRecibidos['funcionario']; ?></em><strong><em><span class="Estilo1">&nbsp;&lt;<?php echo $row_listaRecibidos['dependencia']; ?>::PREFECTURA DE ORURO&gt;</span></em><br />
para:</strong><em><?php echo $row_listaRecibidos['fun_dest']; ?></em> de la ::<em><?php echo $row_listaRecibidos['dep_dest']; ?></em></td>
              </tr>
            </table></td>
          <td>&nbsp;</td>
      </tr>
