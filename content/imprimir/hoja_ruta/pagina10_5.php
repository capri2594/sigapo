...
mysql_select_db($database_snet, $snet);
$query_listar_destinos = sprintf("SELECT * FROM derivacion WHERE derivacion.hojaruta_cod=%s AND  derivacion.nro_destino>28 ORDER BY derivacion.nro_destino ASC", GetSQLValueString($codigo_listar_destinos, "text"));
...
<table width="100%" border="0">
  <tr>
    <td><table width="100%" border="0">
        ...
        <tr>
          <td>&nbsp;</td>
          <td><div align="right"><span class="CollapsiblePanelTabHover">(Pág 10)</span></div></td>
        ...
        <td><table width="100%" border="0">
            <tr>
              <td width="180"><table width="100%" border="0">
                  <tr>
                    <td width="34"><div class="n_destinatario">29</div></td>
                    <td>DESTINATARIO: </td>
                  </tr>
              </table></td>
      ...
      <tr>
        <td><table width="100%" border="0">
          <tr>
            <td width="180"><table width="100%" border="0">
              <tr>
                <td width="34"><div class="n_destinatario">30</div></td>
                <td>DESTINATARIO: </td>
              </tr>
            </table></td>
            <td><div class="objeto"><span class="Estilo33"><?php echo $row_listar_destinos['fun_destino']; ?>
        ...
        <tr>
          <td><table width="100%" border="0">
              <tr>
                <td width="180"><table width="100%" border="0">
                    <tr>
                      <td width="34"><div class="n_destinatario">31</div></td>
                      <td>DESTINATARIO: </td>
                    </tr>
                </table></td>
                <td><div class="objeto"><span class="Estilo33"><?php echo $row_listar_destinos['fun_destino']; ?>
