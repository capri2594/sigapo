...
<table width="100%" border="0">
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><table width="100%" border="0" bgcolor="#FBFDFF" class="cuadro">
            <tr>
              <td><img src="../../imagen/escudo_oruro.png" alt="ESCUDO" width="62" height="66" longdesc="BOLIVIA" /></td>
        ...
        <td width="150"><table width="100%" border="0" class="PROVEIDO">
            ...
            <tr>
              <td><span class="Estilo19">codigo para hacer seguimiento</span></td>
            </tr>
        </table></td>
      </tr>
  ...
  <tr class="destinatarios">
    <td height="35" class="destinatarios">PRIMER DESTINATARIO:  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="Estilo24"><?php echo $row_obtener_hr['primerfun_destino']; ?>&nbsp;(<?php echo $row_obtener_hr['primer_destino']; ?>)</span></td>
  </tr>
  <tr>
        ...
        <td><table width="100%" border="0">
          <tr>
            <td><div align="right">
              <table width="100%" border="0">
                  <tr>
                    <td width="100">FECHA DERIVACION: </td>
                    <td width="100"><div class="hojas" style="width:100px;"><?php 
                    ...
                    <td width="40">HORA:</td>
                    <td width="50"><div class="hojas" style="width:50px;">
      ...
      <tr>
        <td><table width="100%" border="0">
            <tr>
              ...
              <td><div class="Estilo29"><?php echo $row_listar_destinos['fun_destino']; ?> &nbsp;&nbsp;(<?php echo $row_listar_destinos['dep_destino']; ?>)</div></td>
              </tr>
  ...
  <tr>
        ...
        <td><table width="100%" border="0">
          <tr>
            <td valign="top"><table width="100%" border="0">
              <tr>
                <td width="160">Instruccion Adicional: </td>
                <td><div class="cuadroInstruccion"></div></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="destinatarios">
      ...
      <tr>
        <td><table width="100%" border="0">
          <tr>
            <td width="180">CUARTO DESTINATARIO: </td>
            <td><div class="objeto"></div></td>
          </tr>
        </table></td>
      </tr>
