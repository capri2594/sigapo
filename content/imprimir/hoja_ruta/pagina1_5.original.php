    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><table width="100%" border="0" bgcolor="#FBFDFF" class="cuadro">
            <tr>
              <td><img src="../../imagen/escudo_oruro.png" alt="ESCUDO" width="62" height="55" longdesc="BOLIVIA" /></td>
...
<?php }?>
        ...
        <td><table width="100%" border="0">
          <tr>
            <td><div align="right">
              <table width="100%" border="0">
                  <tr>
                    <td width="100"><div align="right">FECHA:&nbsp; </div></td>
                    <td width="100"><div class="hojas" style="width:100px;">
                      <?php 
					$derivacion=explode(" ", $row_obtener_hr['fecha_creacion']);
      ...
      <tr>
        <td><table width="100%" border="0">
            <tr>
              ...
              <td align="left" ><div class="objeto" style="width:97%;">
                <span align="left" class="Estilo29"><?php echo $row_listar_destinos['fun_destino']; ?>
  ...
  &nbsp;&nbsp;(<?php echo $row_listar_destinos['dep_destino']; ?>)
      ...
      <tr style="height:16px;">
        <td><table width="100%" border="0">
          <tr height="15px">
            <td width="180" height="21"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="Estilo12">&nbsp;Objeto: </span></td>
            <td><div class="objeto" style="height:16px;"><?php echo $row_listar_destinos['proveido']; ?></div></td>
            </tr>
        ...
        <td><table width="100%" border="0">
            <tr>
              <td valign="top"><table width="100%" border="0">
                  <tr>
                    <td width="160"><span class="Estilo12">Instruccion Adicional: </span></td>
      ...
      <tr>
        <td><table width="100%" border="0">
          <tr>
            ...
            <td><div class="objeto"><span class="Estilo29"><?php echo $row_listar_destinos['fun_destino']; ?>
              <?php if ($row_listar_destinos['dep_destino']!="") {?>
&nbsp;&nbsp;(<?php echo $row_listar_destinos['dep_destino']; ?>)
<?php }?>
            </span></div></td>
      ...
      <tr>
        <td><table width="100%" border="0">
          <tr>
            <td width="100" height="21"><span class="Estilo12">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Objeto: </span></td>
            <td><table width="100%" border="0">
              <tr height="25">
                ...
                <td height="25"><div class="cuadrillas"></div></td>
                <td width="30" height="25">&nbsp;</td>
                <td height="25"><div align="right" class="Estilo26">Preparar Respuesta&nbsp;</div></td>
                <td height="25"><div class="cuadrillas"></div></td>
                <td width="30" height="25">&nbsp;</td>
                <td height="25"><div align="right" class="Estilo26">Preparar Informe&nbsp;&nbsp;</div></td>
                <td height="25"><div class="cuadrillas"></div></td>
              </tr>
              <tr>
                ...
                <td height="25"><div class="cuadrillas"></div></td>
                <td width="30" height="25">&nbsp;</td>
                <td height="25"><div align="right" class="Estilo26">Procesar&nbsp;&nbsp;&nbsp;</div></td>
                <td height="25"><div class="cuadrillas"></div></td>
                <td width="30" height="25">&nbsp;</td>
                <td height="25"><div align="right" class="Estilo26">Archivo&nbsp;&nbsp;</div></td>
                <td height="25"><div class="cuadrillas"></div></td>
              </tr>
            </table></td>
          </tr>
      ...
      <tr>
        <td><table width="100%" border="0">
            <tr>
              <td><div align="right">FECHA:&nbsp; </div></td>
              <td width="150"><div class="hojas" style="width:150px;"></div></td>
              <td width="50"><div align="right">HORA: &nbsp; </div></td>
              <td width="150"><div class="hojas" style="width:50px;"></div></td>
              <td width="250">FIRMA :.................................................</td>
            </tr>
        </table></td>
      </tr>
