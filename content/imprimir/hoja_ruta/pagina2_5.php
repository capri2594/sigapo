...
mysql_select_db($database_snet, $snet);
$query_listar_destinos = sprintf("SELECT * FROM derivacion WHERE derivacion.hojaruta_cod=%s AND  derivacion.nro_destino>4 ORDER BY derivacion.nro_destino ASC", GetSQLValueString($codigo_listar_destinos, "text"));
  ...
  <tr>
    <td><table width="100%" border="0">
        <tr>
          <td width="300">&nbsp;</td>
          <td>&nbsp;</td>
          <td><div align="right" class="Estilo34">HOJA DE RUTA</div></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td><div align="right"><span class="CollapsiblePanelTabHover">(Pág 2)</span></div></td>
          <td><div align="right"><span class="CollapsiblePanelTabHover Estilo32"><?php echo $_GET['cod']; ?></span></div></td>
        </tr>
    </table></td>
  </tr>
  <tr>
        ...
        <td><table width="100%" border="0">
            <tr>
              <td width="180"><table width="100%" border="0">
                  <tr>
                    <td width="34"><div class="n_destinatario">5</div></td>
                    <td>DESTINATARIO: </td>
                  </tr>
              </table></td>
      ...
      <tr>
        <td><table width="100%" border="0">
          <tr>
            <td width="180"><table width="100%" border="0">
              <tr>
                <td width="34"><div class="n_destinatario">6</div></td>
                <td>DESTINATARIO: </td>
              </tr>
            </table></td>
            <td><div class="objeto"><span class="Estilo33"><?php echo $row_listar_destinos['fun_destino']; ?>
...
<?php }?>
      ...
      <tr>
        <td><table width="100%" border="0">
            <tr>
              <td><div align="right">FECHA:&nbsp; </div></td>
              <td width="150"><div class="hojas" style="width:150px;"><span class="hojas" style="width:150px;">
                <?php 
					$derivacion=explode(" ",$row_listar_destinos['fecha_derivacion']);
					$fecha=explode("-",$derivacion[0]);
					$hora=explode(":",$derivacion[1]);
              ...
              <td width="50"><div align="right">HORA: &nbsp; </div></td>
              <td width="150"><div class="hojas" style="width:50px;"><span class="hojas" style="width:50px;">
                <?php /*echo $hora[0]." h:".$hora[1]." m:".$hora[2]." s"; */
					if ($hora[0]!="")
					echo $hora[0].":".$hora[1];
        ...
        <tr>
          <td><table width="100%" border="0">
              <tr>
                <td width="180"><table width="100%" border="0">
                    <tr>
                      <td width="34"><div class="n_destinatario">7</div></td>
                      <td>DESTINATARIO: </td>
                    </tr>
                </table></td>
                <td><div class="objeto"><span class="Estilo33"><?php echo $row_listar_destinos['fun_destino']; ?>
