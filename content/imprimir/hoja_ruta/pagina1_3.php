...
.n_destinatario {
	...
	font-size: 36px;
	color: #000000;
	background-image: url(../arco-4.gif);
	height: 40px;
	width: 40px;
...
<table width="100%" border="0">
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><table width="100%" border="0" bgcolor="#FBFDFF" class="cuadro">
            <tr>
              <td><img src="../../imagen/Escudo-de-Bolivia.gif" alt="ESCUDO" width="66" height="51" longdesc="BOLIVIA" /></td>
              ...
              <td><img src="../../imagen/logo2.gif" alt="PREF" width="78" height="58" longdesc="PREFECTURA" /></td>
            </tr>
        </table></td>
  ...
  <tr class="destinatarios">
    <td height="35" class="destinatarios">PRIMER DESTINATARIO:  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="Estilo24"><?php echo $row_obtener_hr['primerfun_destino']; ?>
            ...
            <td><div align="right">
              <table width="100%" border="0">
                  <tr>
                    ...
                    <td width="100"><div class="hojas" style="width:100px;">
                      <?php 
      ...
      <tr>
        <td><table width="100%" border="0">
            <tr>
              ...
              <td><div class="Estilo29"><?php echo $row_listar_destinos['fun_destino']; ?>
