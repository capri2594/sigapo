...
.Estilo29 {font-family: Arial, Helvetica, sans-serif; border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; border-top-style: none; border-right-style: none; border-bottom-style: dotted; border-left-style: none; border-top-color: #666666; border-right-color: #666666; border-bottom-color: #666666; border-left-color: #666666; height: 30px; width: 400px; vertical-align: 12%; font-size: 13px; }
-->
</style>
</head>
...
<table width="100%" border="0">
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><table width="100%" border="0" bgcolor="#FBFDFF" class="cuadro">
            <tr>
              <td><img src="../../imagen/escudo_oruro.png" alt="ESCUDO" width="58" height="61" longdesc="BOLIVIA" /></td>
        ...
        <td width="150"><table width="100%" border="0" class="PROVEIDO">
            ...
            <tr>
              <td><span class="CollapsiblePanelTabHover"><?php echo $_GET['cod']; ?></span></td>
            </tr>
            <tr>
              <td><span class="Estilo19">Utilice este codigo para hacer seguimiento</span></td>
            </tr>
        </table></td>
      </tr>
  ...
  <tr>
    <td><table width="100%" border="0" class="destinatarios">
      <tr>
        <td width="110"><div align="right">Remitente:&nbsp;</div></td>
      ...
      <tr>
        <td width="110"><div align="right">asunto/referencia:&nbsp;</div></td>
  ...
  <tr class="destinatarios">
    <td height="35" class="destinatarios">PRIMER DESTINATARIO:  &nbsp;&nbsp;<span class="Estilo24"><?php echo $row_obtener_hr['primerfun_destino']; ?><?php if ($row_obtener_hr['primer_destino']!="") {?>&nbsp;(<?php echo $row_obtener_hr['primer_destino']; ?>)<?php }?></span></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="destinatarios">
      ...
      <tr>
        <td><table width="100%" border="0">
          <tr>
            <td><div align="right">
              <table width="100%" border="0">
                  <tr>
                    ...
                    <td>HORA:</td>
                    <td><div class="hojas"><?php /*echo $hora[0]." h:".$hora[1]." m:".$hora[2]." s"; */
					if ($hora[0]!="")
					echo $hora[0].":".$hora[1];
            ...
            <td width="100"><div align="right">Nº de Hojas:&nbsp;</div></td>
            <td width="130"><div align="left" class="hojas"><?php echo $row_listar_destinos['nhojas']; ?></div></td>
            </tr>
          <tr>
            <td><div align="right"></div></td>
            <td width="100"><div align="right">anexos:&nbsp;</div></td>
      ...
      <tr>
        <td><table width="100%" border="0">
            <tr>
              <td width="180">SEGUNDO DESTINATARIO: </td>
              <td><div class="Estilo29"><?php echo $row_listar_destinos['fun_destino']; ?> <?php if ($row_listar_destinos['dep_destino']!="") {?>&nbsp;&nbsp;(<?php echo $row_listar_destinos['dep_destino']; ?>)<?php }?></div></td>
              </tr>
      ...
      <tr>
        <td><table width="100%" border="0">
          <tr>
            <td width="180" height="21">Objeto: </td>
            <td><div class="Estilo29"><?php echo $row_listar_destinos['proveido']; ?></div></td>
            </tr>
      ...
      <tr>
        <td><table width="100%" border="0">
            <tr>
              <td valign="top">Instruccion Adicional: </td>
              </tr>
            <tr>
              <td valign="top"><div class="cuadroInstruccion">
      ...
      <tr>
        <td><table width="100%" border="0">
          <tr>
            <td>FECHA RECEPCION:
              <div class="hojas"></div></td>
            <td>HORA RECEPCION:
              <div class="hojas"></div></td>
            <td width="250">FIRMA PROVEIDO:..............................................</td>
          </tr>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="destinatarios">
      ...
      <tr>
        <td><table width="100%" border="0">
          <tr>
            <td width="180">TERCER DESTINATARIO: </td>
            <td><div class="objeto"></div></td>
          </tr>
        </table></td>
      </tr>
      <tr>
        <td><table width="100%" border="0">
          <tr>
            ...
            <td><table width="100%" border="0">
              ...
              <tr>
                <td height="30"><span class="Estilo26">
              ...
              <tr>
                <td height="30"><div align="right" class="Estilo26">Para su conocimiento&nbsp;&nbsp;</div></td>
                <td height="30"><div class="cuadrillas"></div></td>
                <td width="30">&nbsp;</td>
                <td height="30"><div align="right" class="Estilo26">Para Consejo Dptal.&nbsp;&nbsp;</div></td>
                <td height="30"><div class="cuadrillas"></div></td>
                <td width="30">&nbsp;</td>
              ...
              <tr>
                ...
                <td height="30"><div class="cuadrillas"></div></td>
                <td width="30">&nbsp;</td>
                <td height="30"><div align="right" class="Estilo26">Para Consejo Tecnico&nbsp;&nbsp;</div></td>
                <td height="30"><div class="cuadrillas"></div></td>
                <td width="30">&nbsp;</td>
                <td height="30">&nbsp;</td>
                <td><div class="cuadrillas"></div></td>
      ...
      <tr>
        <td><table width="100%" border="0">
          ...
          <tr>
            <td valign="top"><div class="cuadroInstruccion" style="height:110px;">&nbsp;</div></td>
          </tr>
        </table></td>
      </tr>
      <tr>
        <td><table width="100%" border="0">
            <tr>
              ...
              <td>HORA RECEPCION:
                <div class="hojas"></div></td>
              <td width="300">FIRMA PROVEIDO:..............................................</td>
            </tr>
        </table></td>
      </tr>
    </table></td>
