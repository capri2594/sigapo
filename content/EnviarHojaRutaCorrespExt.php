...
<form action="HojaRutaExt.php" method="POST" name="formHR" id="formHR">
  <table width="100%" border="0" cellspacing="1" cellpadding="7">
  <tr>
    <td><table width="100%" border="0" cellspacing="1" cellpadding="0">
      <tr>
        <td><div class="subrayado">CODIGO</div></td>
      </tr>
      <tr>
        <td><table width="100%" border="0" cellspacing="1" cellpadding="2">
            ...
            <tr>
              <td width="24%" align="right" valign="middle">
                <div align="right"><span class="paso_normal"><?php echo $_SESSION['cod_dep']; ?></span><span >
              ...
              <input name="codHR" type="text" id="codHR" size="30" />
              <span class="textfieldRequiredMsg">Se necesita un numero.</span><span class="textfieldInvalidFormatMsg">[x] Invalido. Solo digitos 0..9</span></span></td>
...
<tr>
     ...
     <tr>
       <td><table width="100%" border="0" cellspacing="1" cellpadding="7">
           <tr>
             <td><div class="cuadro" id="muestra-resultado"><span class="Estilo26"><img src="imagen/b_tipp.png" width="16" height="16" />&nbsp;<span class="Estilo27">Inserte nuevo codigo de Hoja de Ruta. (Para Correspondencia Externa)</span></span><br />
             </div></td>
           </tr>
       </table></td>
     </tr>
