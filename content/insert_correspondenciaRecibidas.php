...
$query_corresp = sprintf("SELECT * FROM salinternas, salidas WHERE salinternas.salidas_cite=salidas.cite  and salinternas.dep_destino=%s AND salidas.fun_proveido is NOT NULL ORDER BY salidas.fecha_envio DESC", GetSQLValueString($depto_corresp, "text"));
...
<table width="121" border="0" cellspacing="1" cellpadding="0">
          <tr >
            ...
            <td width="100" bordercolor="#F4F4F4" bgcolor="#F0F0F0"><table width="100" border="0" cellspacing="1" cellpadding="0" onmouseover="className='b_over'" onmouseout="className='b_normal'" class="b_normal" onclick="location.href='insert_correspondenciaRecibidas.php';">
                <tr>
