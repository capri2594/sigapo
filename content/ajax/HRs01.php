...
$query_obtener_codHR = sprintf("SELECT hojaruta.cod FROM hojaruta WHERE cod LIKE %s AND gestion=%s ORDER BY hojaruta.cod  ASC LIMIT 0,50", GetSQLValueString($texto_obtener_codHR."%", "text"),GetSQLValueString($texto_obtener_gestion, "text"));
