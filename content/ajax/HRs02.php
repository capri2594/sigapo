...
if (isset($_GET['texto'])) {
 ...
 $texto_obtener_gestion = "-1";
if (isset($_GET['gestion'])) {
  $texto_obtener_gestion = $_GET['gestion'];
}

mysql_select_db($database_snet, $snet);
$query_obtener_codHR = sprintf("SELECT hojaruta.cod FROM hojaruta WHERE cod LIKE %s AND gestion=%s ORDER BY hojaruta.cod  ASC LIMIT 0,10", GetSQLValueString($texto_obtener_codHR."%", "text"),GetSQLValueString($texto_obtener_gestion, "text"));
