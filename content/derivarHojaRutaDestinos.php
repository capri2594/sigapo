...
id="procedencia"><?php echo $row_obtener_hr['procedencia']; ?></div>
          </td>
          <td>&nbsp;</td>
        </tr>
        <tr>
  ...
  <tr class="titulos">
    <td><table width="100%" border="0">
        <tr>
          ...
          <td width="70"><input name="button16" type="button" class="b_imprimir" id="button16" onclick="MM_openBrWindow('imprimir/hoja_ruta/pagina11_5.php?cod=<?php echo $_GET['cod'];?>','pag1','menubar=yes,scrollbars=yes,resizable=yes,width=900,height=700')" value="Pag. (11)" /></td>
          <td width="70"><input name="button15" type="button" class="b_imprimir" id="button15" onclick="MM_openBrWindow('imprimir/hoja_ruta/pagina10_5.php?cod=<?php echo $_GET['cod'];?>','pag1','menubar=yes,scrollbars=yes,resizable=yes,width=900,height=700')" value="Pag. (10)" /></td>
          <td width="70"><input name="button14" type="button" class="b_imprimir" id="button14" onclick="MM_openBrWindow('imprimir/hoja_ruta/pagina9_5.php?cod=<?php echo $_GET['cod'];?>','pag1','menubar=yes,scrollbars=yes,resizable=yes,width=900,height=700')" value="Pag. (9)" /></td>
          <td width="70"><input name="button13" type="button" class="b_imprimir" id="button13" onclick="MM_openBrWindow('imprimir/hoja_ruta/pagina8_5.php?cod=<?php echo $_GET['cod'];?>','pag1','menubar=yes,scrollbars=yes,resizable=yes,width=900,height=700')" value="Pag. (8)" /></td>
          <td width="70"><input name="button12" type="button" class="b_imprimir" id="button12" onclick="MM_openBrWindow('imprimir/hoja_ruta/pagina7_5.php?cod=<?php echo $_GET['cod'];?>','pag1','menubar=yes,scrollbars=yes,resizable=yes,width=900,height=700')" value="Pag. (7)" /></td>
          <td width="70"><input name="button11" type="button" class="b_imprimir" id="button11" onclick="MM_openBrWindow('imprimir/hoja_ruta/pagina6_5.php?cod=<?php echo $_GET['cod'];?>','pag1','menubar=yes,scrollbars=yes,resizable=yes,width=900,height=700')" value="Pag. (6)" /></td>
          <td width="70"><input name="button9" type="button" class="b_imprimir" id="button9" onclick="MM_openBrWindow('imprimir/hoja_ruta/pagina5_5.php?cod=<?php echo $_GET['cod'];?>','pag1','menubar=yes,scrollbars=yes,resizable=yes,width=900,height=700')" value="Pag. (5)" /></td>
          <td width="70"><input name="button8" type="button" class="b_imprimir" id="button8" onclick="MM_openBrWindow('imprimir/hoja_ruta/pagina4_5.php?cod=<?php echo $_GET['cod'];?>','pag1','menubar=yes,scrollbars=yes,resizable=yes,width=900,height=700')" value="Pag(4)" /></td>
          <td width="70"><input name="button7" type="button" class="b_imprimir" id="button7" onclick="MM_openBrWindow('imprimir/hoja_ruta/pagina3_5.php?cod=<?php echo $_GET['cod'];?>','pag1','menubar=yes,scrollbars=yes,resizable=yes,width=900,height=700')" value="Pag. (3)" /></td>
          <td width="70"><input name="button6" type="button" class="b_imprimir" id="button6" onclick="MM_openBrWindow('imprimir/hoja_ruta/pagina2_5.php?cod=<?php echo $_GET['cod'];?>','pag1','menubar=yes,scrollbars=yes,resizable=yes,width=900,height=700')" value="Pag(2)" /></td>
          <td width="70">
            <div align="right">
              <input name="button5" type="button" class="b_imprimir" id="button5" onclick="MM_openBrWindow('imprimir/hoja_ruta/pagina1_5.php?cod=<?php echo $_GET['cod'];?>','pag1','menubar=yes,scrollbars=yes,resizable=yes,width=900,height=700')" value="Pag(1)" />
              </div>          </td>
      ...
      <tr class="botones">
        ...
        <td width="70" height="25">Estado</td>
          ...
          <tr class="celdas">
            ...
            <td width="100">&nbsp;</td>
            <td width="70"><img src="imagen/conformidad_accept.gif" alt="si" width="16" height="16" longdesc="si" /> <span class="Estilo4"><span class="Estilo8">Recibido</span></span></td>
        </tr>
          <?php if ($totalRows_listar_destinos > 0) { // Show if recordset not empty ?>
            ...
            <tr class="celdas">
              ...
              <td width="70"><?php if ($row_listar_destinos['entradas_id']>0){ ?><img src="imagen/conformidad_accept.gif" alt="si" width="16" height="16" longdesc="si" />
                <span class="Estilo4"><span class="Estilo8">Recibido</span>.              </span>
                <?php }else{?><img src="imagen/conformidad_error.gif" alt="no" width="16" height="16" longdesc="no" /> <span class="pendiente"> Enviando
                </span>
