...
.ultimohr {
	background-image: url(imagen/1-t1-1.gif);
	background-repeat: no-repeat;
	background-position: left center;
	margin-left: 0px;
	padding-left: 25px;
...
<form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST">
  <table width="100%" border="0">
    <tr>
      <td><span id="preload" style="display: none"> <img src="imagen/loading.gif" alt="Cargando..." /><span class="Estilo1">Cargando...</span></span><div align="right">
          ...
          <td><fieldset>
            ...
            <table width="100%" border="0">
              <tr>
                ...
                <td width="220" height="30" ><span id="sprytextfield1"><label>
                  <input name="seg_f_destino" type="text" id="seg_f_destino" size="30" />
                  <div id="lista_opciones" class="autocomplete"></div></label>
          ...
          <td><fieldset>
            ...
            <table width="100%" border="0">
              ...
              <tr>
                ...
                <td><label>
                  <input name="codigo" type="button" class="ultimohr" id="codigo" onclick="ultimoHR1();" value="codigo" />
                </label></td>
                </tr>
              </table>
          </fieldset>          </td>
        ...
        <tr>
          <td><fieldset>
            ...
            <table width="100%" border="0">
              ...
              <tr>
                <td>Anexos</td>
                <td><textarea name="anexos" cols="35" rows="3" class="anexos" id="anexos">-
-</textarea></td>
              </tr>
              <tr>
                <td>Obs.</td>
                <td><textarea name="obs" cols="35" rows="5" class="obs" id="obs">N.A.</textarea></td>
              </tr>
              </table>
          </fieldset>          </td>
    ...
    <tr>
      <td><label>
        <input name="button" type="submit" class="guardar" id="button" value="Guardar Registro de Correspondencia" />
      </label></td>
    </tr>
  </table>
