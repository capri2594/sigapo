...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><table width="100%" border="0" cellspacing="3" cellpadding="1" id="titulos">
        ...
        <tr>
          <td><div align="center" class="Estilo2">REGISTRO DE SALIDAS (DERIVACI&Oacute;N)</div></td>
        </tr>
      </table></td>
  </tr>   
...
<?php if ($totalRows_salidas_hr == 0) { // Show if recordset empty ?>
  <tr>
      ...
      <td class="datos">No se tiene registro de salidas de HOJAS DE RUTA, hasta el momento.</td>
