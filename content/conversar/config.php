...
//define('LACE_URL_ABS', $URL);
   
define('LACE_URL_ABS', 'http://sirc.sigapo/sirc_10/content/conversar');

/** Relative URL to Lace including trailing slash
   (e.g. '/lace/' or simply '/') */
define('LACE_URL_REL', '/sirc_10/content/conversar/');
...
define('LACE_SHOW_JOIN_PART', true);
