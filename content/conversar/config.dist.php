...
define('LACE_FLOOD_POST_COUNT', 3);
...
define('LACE_SHOW_NAME_CHANGE', true);
...
/** Limit messages to this many characters
    ...
    message length */
//define('LACE_MAX_TEXT_LENGTH', 1050);
define('LACE_MAX_TEXT_LENGTH', 500);
