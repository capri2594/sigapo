...
$query_corresp = sprintf("SELECT * FROM entradas, eexterna WHERE entradas.id=eexterna.entradas_id AND entradas.cod_deprecibido=%s ORDER BY entradas.fecha_recibido DESC", GetSQLValueString($colname_corresp, "text"));
...
/*	  
 ...
 //     alert(document.getElementById('showfechadoc').value);
   ...
   window.opener.self.document.getElementById('fecha_doc').value=document.getElementById('showfechadoc').value;
	  ...
	  window.opener.self.document.getElementById('aaaa').value=fecha[2];
	  window.opener.self.document.getElementById('mm').value=fecha[1];
	  window.opener.self.document.getElementById('dd').value=fecha[0];
...
<table width="121" border="0" cellspacing="1" cellpadding="0">
          <tr >
            ...
            <td width="100" bordercolor="#F4F4F4" bgcolor="#F0F0F0"><table width="100" border="0" cellpadding="0" cellspacing="1" onclick="location.href='<?php echo $_SERVER['PHP_SELF']; ?>';" onmouseover="className='b_over'" onmouseout="className='b_normal'" class="style3">
                <tr>
      ...
      <td><table width="700" border="0" cellspacing="1" cellpadding="0">
        ...
        <tr>
          ...
          <td><input type="hidden" name="showhojas" id="showhojas" />
            ...
            <input name="show_idinterna" type="text" id="show_idinterna" /></td>
        </tr>
      </table></td>
    </tr>
    <tr bgcolor="#F0F0F0">
            ...
            <tr id="fila<?php echo $i; ?>"  onclick="checkear('checkbox<?php echo $i?>',<?php echo $totalRows_corresp;?>);">
			  ...
			  echo $dia[0]."/".$fch[1]."/".$fch[0]."&nbsp;".$hora[0].":".$hora[1];?>)</em>
                ...
                <input type="hidden" name="anio" id="anio" value="<?php  echo $fch[0];?>"/>
                  ...
                  <input name="id_interna<?php echo $i; ?>" type="text" id="id_interna<?php echo $i; ?>" value="<?php echo $row_corresp['id_externa']; ?>" /></td>
              <td width="150" id="destino<?php echo $i; ?>"><?php echo $row_corresp['fun_destino']; ?><br />
                ...
                <br /></td>
              <td width="150" id="remite<?php echo $i; ?>"><?php echo $row_corresp['remitente']; ?><br />
                &lt;<?php echo $row_corresp['org_remitente']; ?>&gt;
                <input type="hidden" name="FunRemite<?php echo $i; ?>" id="FunRemite<?php echo $i; ?>"  value="<?php echo $row_corresp['remitente']; ?>"/>
                <input type="hidden" name="DepRemite<?php echo $i; ?>" id="DepRemite<?php echo $i; ?>"  value="<?php echo $row_corresp['org_remitente']; ?>"/></td>
    ...
    <tr>
      ...
      <tr>
              ...
              <td width="100"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                  ...
                  <tr>
                    <td><input name="button" type="submit" id="button" onclick="MM_openBrWindow('RecibirInternos1.php','vInsertarNuev','width=650,height=545')" value="Nuevo" /></td>
