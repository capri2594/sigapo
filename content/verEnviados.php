...
<body>
<h3 align="center">Enviados HOY<span class="style4">(<?php 
  ...
  <?php if ($totalRows_listaEnviados > 0) { // Show if recordset not empty ?>
        <?php do { ?>
          <tr <?php if (($i%2)==0) echo "class=\"par\""; else echo "class=\"impar\"";?>>
            ...
            <td><?php echo $row_listaEnviados['fun_remitente']; ?></td>
            <td><?php echo $row_listaEnviados['fun_proveido']; ?>(<?php echo $row_listaEnviados['fecha_proveido']; ?>)</td>
          </tr>
