      ...
      <div class="CollapsiblePanelContent">
        <table width="100%" border="1" cellpadding="0" cellspacing="0" bgcolor="#F3F3F3" id="id_hruta">
          ...
          <tr height=11>
            ...
            <td width="32%" rowspan="2" class="par">&nbsp;</td>
          ...
          <tr height=11>
            <td colspan="9" class="par">2.- DATOS DE LA CORRESPONDENCIA</td>
          </tr>
          <tr height=11>
            <td class="par">&nbsp;</td>
    ...
    <div id="CollapsiblePanel2" class="CollapsiblePanel">
      ...
      <div class="CollapsiblePanelContent">
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td width="8%" rowspan="3" class="par"><div align="center" class="Estilo6">Remitente</div></td>
            <td colspan="3" class="impar"><div align="center">Nombres y Apellidos&nbsp;</div></td>
            <td width="8%" rowspan="3" class="par"><div align="center">Destinatario</div></td>
            <td colspan="3" class="impar"><div align="center">Nombres y Apellidos&nbsp;</div></td>
            <td width="1%" rowspan="3" class="c1">&nbsp;</td>
          </tr>
          <tr>
            <td colspan="3" bgcolor="#FFFFFF"><span id="sprytextfield1">
              <input name="text1" type="text" class="textos" id="text1" size="52" />
            <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
            <td colspan="3" bgcolor="#FFFFFF"><span id="sprytextfield2">
              <input name="text2" type="text" class="textos" id="text2" size="40" />
            <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
          </tr>
          <tr>
            <td colspan="3" class="impar"><div align="center"><?php echo $_GET[coddep]?></div></td>
            <td colspan="3" class="impar"><div align="center">{UNIDAD A LA QUE CORRESPONDE}</div></td>
          </tr>
          <tr>
