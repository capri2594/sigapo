...
if (isset($_GET['cite'])) {
  $cite_var_reg_Internos = $_GET['cite'];
}
mysql_select_db($database_snet, $snet);
...
document.body.insertAdjacentHTML('beforeEnd', WebBrowser); WebBrowser1.ExecWB(6, -1); WebBrowser1.outerHTML = "";
              ...
              <td><input name="button3" type="button" id="button3" onclick="if(confirm('¿Esta seguro de cancelar la operacion, \n se perderan todos los datos?')){MM_goToURL('self','menuRecibirInternos3.php');return document.MM_returnValue;}" value="Registrar Nueva Correspondencia" /></td>
            </tr>
                  </table>
      </div></td>
    <td valign="top">&nbsp;</td>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="2" cellpadding="0">
          ...
          <tr>
            ...
            <td>
              <input name="fecha_doc" type="hidden" id="fecha_doc" style="visibility:visible" value="<?php echo $row_reg_Internos['fecha_doc']; ?>"  /> 
  ...
  <tr>
    ...
    <td><table width="300" border="0" cellspacing="5" cellpadding="0">
          <tr>
            <td>&nbsp;</td>
            <td><input type="button" name="button2" id="button2" value="Imprimir Boleta" onclick="imprimir();"/></td>
            <td><input name="button" type="button" id="button" onclick="if(confirm('¿Esta seguro de cancelar la operacion, \n se perderan todos los datos?')){MM_goToURL('self','menuRecibirInternos3.php');return document.MM_returnValue;}" value="Registrar Nueva Correspondencia" /></td>
          </tr>
      </table></td>
    <td>&nbsp;</td>
</tr>
