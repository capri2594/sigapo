  ...
  <?php if ($totalRows_obtener_hr > 0) { // Show if recordset not empty ?>
   <tr bgcolor="#E5ECF7">
     <td><table width="300" border="0" cellpadding="0" cellspacing="0">
       <tr>
         <td width="120" bgcolor="#6B7A9D"><span class="Estilo21">.:: Hoja de Ruta</span></td>
         <td width="5"><img src="imagen/sombra_pestaña.png" width="7" height="30" /></td>
         <td width="100">&nbsp;</td>
         <td width="5">&nbsp;</td>
         <td>&nbsp;</td>
       </tr>
...
new Ajax.InPlaceEditor($('refe'), 'ajax/cambiar_ref.php?cod=<?php echo $row_obtener_hr['cod']; ?>&idinterna=<?php echo $row_obtener_hr['einterna_id']; ?>&idexterna=<?php echo $row_obtener_hr['eexterna_id']; ?>', {
  ...
  <tr class="titulos">
    <td><table width="100%" border="0" align="right" style="border-width:0px;">
        <tr>
          <td width="150"><img src="imagen/destino.gif" alt="destino" width="16" height="16" longdesc="destino" /> ¦- - -&nbsp;Destinatarios </td>
          <td align="right"><table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-style:solid;border-width:0px; margin:0px; padding:0px; border:0px; height:30px; width:750px; ">

            <tr style="height:30px;">
              <td width="9" height="30" class="barra_espacio">&nbsp;</td>
              <td width="40" height="30" class="barra"><div class="actualizar" id="button2" onclick="window.location.reload()" style="height:30px;" title="Actualizar">
              </div></td>
              <td width="9" height="30" class="barra_espacio">&nbsp;</td>
              <td width="15" height="30" class="barra">&nbsp;</td>
              <td width="40" height="30" class="barra"><span class="Estilo19">Pag</span></td>
              <td width="280" height="30" class="barra" style="width:250px;"><span id="sprytextfield1">
                <input name="textfield" type="text" id="textfield"  maxlength="2" style="width:30px; padding-left:5px;"/>
                <span class="Estilo19">/10</span>
                
                <span class="textfieldRequiredMsg">x.</span><span class="textfieldMaxValueMsg" style="z-index:3; position:relative;">No permitido.</span><span class="textfieldMaxCharsMsg">solo 2 digitos.</span><span class="textfieldMinCharsMsg">x.</span><span class="textfieldInvalidFormatMsg">Formato no válido. </span><span class="textfieldMinValueMsg">NO permitido.</span></span></td>
              <td width="50" height="30" class="barra_imprimir">&nbsp;</td>
              <td class="barra">&nbsp;</td>
              <td width="77" height="30" class="barra"><div class="b_imprimir2" id="button7" onclick="MM_openBrWindow('imprimir/hoja_ruta/pagina3_5.php?cod=<?php echo $_GET['cod'];?>','pag1','menubar=yes,scrollbars=yes,resizable=yes,width=900,height=700')" title="Ver IMPRIMIR Pag. 3" ><span class="Estilo17">Pag. 3</span></div></td>
              <td width="77" height="30" class="barra"><div class="b_imprimir2" id="button2" onclick="MM_openBrWindow('imprimir/hoja_ruta/pagina2_5.php?cod=<?php echo $_GET['cod'];?>','pag1','menubar=yes,scrollbars=yes,resizable=yes,width=900,height=700')" title="Ver IMPRIMIR Pag. 2"> <span class="Estilo17" style="vertical-align:middle;">Pag. 2</span></div></td>
              ...
              <td width="9" height="30" class="barra_espacio">&nbsp;</td>
              <td width="15" height="30" class="barra">&nbsp;</td>
              <td width="100" height="30" class="barra"><div align="right" class="new_destino" id="button3"  onclick="ndestino('nuevo_destinatarioHR.php?cod=<?php echo $_GET['cod']?>','nuevoDestinatario','width=600,height=400,left=180,top=130')" style="height:30px;" title="AGREGAR NUEVO DESTINO"><span class="Estilo17">Nuevo Destinatario</span>
              </div></td>
              <td width="15" height="30" class="barra">&nbsp;</td>
              <td width="9" height="30" class="barra_espacio">&nbsp;</td>
              <td width="15" height="30" class="barra">&nbsp;</td>
              <td width="90" height="30" class="barra"><div class="b_salir"  id="button10" style="height:30px;" onclick="window.close();" title="SALIR de la Hoja de Ruta"><span class="Estilo17">Finalizar</span> </div></td>
