...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
  ...
  <tr>
    <td><div id="CollapsiblePanel2" class="CollapsiblePanel">
      <div class="CollapsiblePanelTab" tabindex="0">Ultima derivacion.- </div>
      <div class="CollapsiblePanelContent">
        <table width="100%" border="0" cellspacing="1" cellpadding="3">
          <tr>
            <td><span class="Estilo2"><span id="sprytextfield1">
            <label>
            <input name="num" type="text" id="num" size="3"  value="<?php echo $row_Record_hojaruta['cont_destinos']; ?>"/>
            </label>
            <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldInvalidFormatMsg">Formato no válido.</span></span>.- DESTINATARIO:</span> <span class="Estilo4"><?php echo $row_Record_derivacion['fun_destino']; ?>&nbsp;&laquo;<span class="Estilo27"><?php echo $row_Record_derivacion['dep_destino']; ?></span>&raquo;
...
<?php if ($totalRows_Record_hojaruta == 0) { // Show if recordset empty ?>
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="0">
    ...
    <tr>
      <td> <div align="center" class="Estilo29">La HOJA DE RUTA <?PHP echo $_POST['cod'];?> esta deshabilitada o no esta para envio todavia.<br />
        <br />
        Contactese con la Unidad de Sistema para verificar.</div></td>
      </tr>
  </table>
