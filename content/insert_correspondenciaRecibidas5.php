...
//v9.0
	...
	if (objcheck=getElementById(check))
		...
		document.getElementById('showfechadoc').value=document.getElementById('fechadoc'+i).value;		  
			}
...
<table width="121" border="0" cellspacing="1" cellpadding="0">
          <tr >
            ...
            <td width="100" bordercolor="#F4F4F4" bgcolor="#F0F0F0"><table width="100" border="0" cellpadding="0" cellspacing="1" onclick="location.href='insert_correspondenciaRecibidas4.php';" onmouseover="className='b_over'" onmouseout="className='b_normal'" class="style3">
                <tr>
      ...
      <td><table width="700" border="0" cellspacing="1" cellpadding="0">
        ...
        <tr>
          ...
          <td><input type="hidden" name="showhojas" id="showhojas" />
            ...
            <input name="showfechadoc" type="text" id="showfechadoc" /></td>
        </tr>
      </table></td>
    </tr>
    <tr bgcolor="#F0F0F0">
    ...
    <tr>
      <td><table width="308" border="0" align="right" cellpadding="0" cellspacing="0" bgcolor="#F0F0F0">
            <tr>
              <td width="100"><input name="button" type="submit" id="button" onclick="MM_openBrWindow('RecibirInternos1.php','vInsertarNuevo','width=650,height=545')" value="Nuevo" /></td>
