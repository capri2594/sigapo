...
<?php echo "NOmbre de session<br>"; ?>
<?php echo $_SESSION['dep']; }?>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO salidas (cite, tema_titulo, tipo_clase, dep_remitente, fun_remitente, fecha_envio, `ref`) VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO salinternas (salidas_cite, salidas_tema_titulo, salidas_tipo_clase, nhojas, ladjuntos, danexos, fun_destino, dep_destino) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['cite'], "text"),
                       GetSQLValueString($_POST['tema'], "text"),
                       GetSQLValueString($_POST['tipo'], "text"),
...
<form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
  <table width="100%" border="0" cellspacing="1" cellpadding="0">
    <tr>
      <td>&nbsp;</td>
      <td><div align="left"><span class="Estilo2 style3">fecha de envio:</span><span class="style3">&nbsp;</span> <span style="background-color:#DBFDE2; border-color: #CCCCCC;">&nbsp;
          <?php 
		$t=date("Y-m-d H:i:s");
		print ($t);?>
        &nbsp;&nbsp;          </span>
...
?>
         ...
         <tr>
           <td><fieldset>
               <legend><span class="style3">Remitente</span></legend>
             <table width="90%" border="0" cellspacing="1" cellpadding="0">
             <tr>
               <td><div align="right" class="style4">Dependencia</div></td>
               <td><div align="right"><span id="spryselect7">
                 <select name="dep_remite2" size="1" id="dep_remite2" disabled="disabled">
                   <option value="<?php echo $_SESSION['dep'];;?>" selected="selected"><?php echo $_SESSION['dep'];?></option>
                 </select>
                 <span class="selectRequiredMsg">Seleccione un elemento.</span> </span></div>
                 <input name="dep_remite" type="hidden" value="<?php echo $_GET['dremite'];?>" /></td>
             </tr>
             <tr>
               <td><div align="right" class="style4">Remitente</div></td>
               <td><div align="right"><span id="spryselect9">
                 <select name="fun_remite" id="fun_remite">
                   <?php
do {  
?>
...
?>
           ...
           <td><div style="width:320px;"><fieldset>
                          <legend><span class="style3">Destinatario Interno</span></legend>
               <table width="90%" border="0" cellspacing="1" cellpadding="0">
             <tr>
               <td><span class="style4">Dependencia:</span></td>
               <td><span id="spryselect8"><span class="selectRequiredMsg">Seleccione un elemento.</span>
                  <input name="dep_destino" type="text" id="dep_destino" value="<?php echo $_GET['ddestino'];?>" readonly="readonly"/>
              </span></td>
             </tr>
             <tr>
               <td><span class="style4">Funcionario:</span></td>
...
echo $indice." = ".$valor."<br>"; 
    ...
    <tr>
      <td><div align="right"><span class="Estilo3">*</span>&nbsp;<span class="style3">Nro. Hojas</span></div></td>
