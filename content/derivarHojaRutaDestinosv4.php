...
id=”codhr”><?php echo $row_obtener_hr['cod']; ?></strong></td>
                <td width="60">
                  <label>
                  <input name="button10" type="button" class="editarHR" id="button10" value="Editar" />
                  </label>
                </td>
              </tr>
            </table></td>
        ...
        <tr>
          ...
          <td bgcolor="#FFFFFF"><table width="100%" border="0">
            <tr>
              <td width="20"><img src="imagen/botones/edit.png" alt="editar" longdesc="Editar/Modificar datos" /></td>
              <td><div
        ...
        <tr>
          ...
          <td bgcolor="#FFFFFF"><table width="100%" border="0">
            <tr>
              ...
              <td width="20">
              <img src="imagen/botones/edit.png" alt="editar" longdesc="Editar/Modificar datos" />
              </td>
              <?php }?>
              
              <td><div
id="refe"><?php echo $row_obtener_hr['ref']; ?></div></td>
              </tr>
...
new Ajax.InPlaceEditor($('refe'), 'ajax/cambiar_ref.php?cod=<?php echo $row_obtener_hr['cod']; ?>&idinterna=<?php echo $row_obtener_hr['einterna_id']; ?>&idexterna=<?php echo $row_obtener_hr['eexterna_id']; ?>', {
        submitOnBlur: true, okButton: true, cancelLink: true,
  ...
  <tr class="titulos">
    <td><table width="100%" border="0">
        <tr>
          ...
          <td width="100">
            <div align="right">
              <input name="button5" type="button" class="b_imprimir2" id="button5" onclick="MM_openBrWindow('imprimir/hoja_ruta/pagina1_5.php?cod=<?php echo $_GET['cod'];?>','pag1','menubar=yes,scrollbars=yes,resizable=yes,width=900,height=700')" value="Imprimir (Pag 1)" />
              </div>          </td>
