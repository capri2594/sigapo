  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="3">
      <tr bgcolor="#EDEFF3">
        ...
        <td width="100" height="25">Fecha de Envio<br />
          Mensajero</td>
        <td width="70" height="25">          Fecha Entrega<br />
          Destino</td>
...
Registrado por: <?php echo $row_obtener_hr['usuario_creador']; ?></td>
            ...
            <td width="70"><div align="left" class="fech_entrega"><?php echo cambiar_a_normal_letra_con_hora($row_obtener_hr['fecha_creacion']); ?></div></td>
          ...
          <?php if ($totalRows_listar_destinos > 0) { // Show if recordset not empty ?>
            ...
            <tr class="celdas">
              ...
              <td valign="top"><p><span class="celeste"><?php echo $row_listar_destinos['proveido']; ?><br />
                ...
                <br />
                <div class="Estilo7" style="width:100%;">  atte.&nbsp;&nbsp;<?php echo $row_listar_destinos['fun_derivador']; ?></div></td>
              ...
              <td width="70"><?php if ($row_listar_destinos['entradas_id']>0){ ?>
                ...
                <div class="fech_entrega" id="div_recib<?php echo $row_listar_destinos['entradas_id']; ?>">adsfasd</div>
                <div align="center">
                  <?php }else{?>
