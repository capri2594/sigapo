          ...
          <td><fieldset>
            ...
            <table width="100%" border="0">
              ...
              <tr>
                ...
                <input name="hr" type="text" id="hr" size="10" value="<?php if ($error_repetido){ echo "DUPLICADO"; }?>" />
    ...
    function conMayusculas(field) {
            field.value = field.value.toUpperCase()
              ...
              <tr>
                ...
                <input name="nhojas" type="text" id="nhojas" size="10" maxlength="5" value="<?php if ($error_repetido){ echo $_POST['nhojas']; }?>"/>
...
-<?php }?></textarea></td>
         ...
         <!-- <td><table width="100%" border="0">
          <!--Modificado par que no se muestre tema-->
           <!-- <tr>
              <td><fieldset>
                ...
                <table width="100%" border="0">
                  <tr>
                    ...
                    <td><span id="sprytextfield7">
                      <input name="fech_recib" type="text" class="fechatime" id="fech_recib" value="<?php echo date("Y-m-d H:i:s"); ?>" size="16" />
                      <span class="textfieldRequiredMsg">X.</span></span></td>
                    </tr>
                  <tr>
                    <td>Nom. Recib.</td>
          ...
          <tr><td><fieldset>
                ...
                <table width="100%" border="0">
                  <tr>
                    <td>Fech.Recib.</td>
                    <td><span id="sprytextfield7">
                      <input name="fech_recib" type="text" class="fechatime" id="fech_recib" value="<?php echo date("Y-m-d H:i:s"); ?>" size="20" />
                      <span class="textfieldRequiredMsg">X.</span></span></td>
                    </tr>
                  <tr>
                    <td>Nom. Recib.</td>
        ...
        <input name="button" type="submit" class="guardar" id="button" value="Guardar Registro de Correspondencia"  style="width:300px; height:30px; border: groove; font-weight:bold;"/></div>
      		</label></td></tr></table>
          </tr>
    ...
    <!--<tr>
    	<td><label>
        <input name="button" type="submit" class="guardar" id="button" value="Guardar Registrooooooooooooo de Correspondencia" />
      		</label>
      	</td>
    </tr>-->
  </table>
