...
$nombre_lista_tel_uo = "-1";
if (isset($_GET['txt'])) {
  $nombre_lista_tel_uo = $_GET['txt'];
}
mysql_select_db($database_snet, $snet);
$query_lista_tel_uo = sprintf("SELECT dependencia.nombredep, dependencia.fono1, dependencia.fono2, dependencia.fax, dependencia.id_edificio, dependencia.cod FROM dependencia WHERE dependencia.nombredep LIKE %s", GetSQLValueString("%".$nombre_lista_tel_uo."%", "text"));
