    ...
    <td>
      <table width="100%" border="0">
        <tr>
          ...
          <td width="20px;" align="center" <?php if ($pageNum_salidas_hr-$i){?> class="no_selec" <?php }else{ ?> class="seleccionado" <?php }?><a href="<?php printf("%s?pageNum_salidas_hr=%d%s", $currentPage, $i, $queryString_salidas_hr); ?>" class="navegacion">
              <?php  echo ($i+1);?>
              </a>    </td><?php };?>
        </tr>
      </table>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr class="titulos" id="cabecera" style="visibility:visible;">
        <td width="70" class="titulos">Nº HOJA<br />
          DE RUTA</td>
...
REFERENCIA</td>
        <td width="65" class="titulos">Nº DE<br />
          HOJAS</td>
      ...
      <?php do { ?>
        <tr class="datos" id="datos<?php echo $reg ?>" style="visibility:visible;" onclick="ocultar(this);">
            <td width="70" height="85" class="fecha"><?php echo $row_salidas_hr['hojaruta_cod']; ?></td>
          ...
          <td height="85"><table width="100%" border="0" cellspacing="3" cellpadding="0">
                ...
                <tr>
                  <td class="ref"><strong>ref.&nbsp;</strong><?php echo substr($row_salidas_hr['ref'],0,120);?><?php if (strlen($row_salidas_hr['ref'])>120) {?>."...";<?php }?> </td>
            </tr>
                    </table></td>
          <td width="65" height="85"><table width="100%" border="0" cellspacing="3" cellpadding="0">
                <tr>
          ...
          <td width="140" height="85" valign="top"><table width="100%" border="0" cellspacing="3" cellpadding="0">
            ...
            <tr>
              <td><div class="instruccion"><?php echo substr($row_salidas_hr['mensaje'],0,105); ?><?php if (strlen($row_salidas_hr['mensaje'])>105) {?>...<?php }?></div></td>
            </tr>
          </table></td>
