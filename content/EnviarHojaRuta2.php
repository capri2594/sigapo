...
?>
                  ...
                  &nbsp;&nbsp;
                  <input name="examinar2" type="button" id="examinar2" onclick="MM_openBrWindow('insert_correspondenciaRecibidas.php','Destinatario','status=yes,width=730,height=285')" value="..." />
                  <br />
                  <br />
                  ...
                  <table width="200">
                    <tr>
                      <td><table width="620" border="0" cellpadding="0" cellspacing="0" id="pdestinatarios" style="visibility:hidden;">
                       <?php for($f=1;$f<=4;$f++) {?>
                        <tr>
                          <?php for($c=1;$c<=3;$c++) { ?>
						  <?php
