...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "hoja_ruta")) {
  $insertSQL = sprintf("INSERT INTO hojaruta (cod, einterna_id, fecha_creacion, procedencia, fecha_proveido, fun_proveido, `ref`, primer_destino, primerfun_destino, nhojas, nanexos, usuario_creador, cod_depcreador, cont_destinos) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
function init(){
     ...
     Event.observe('codigo', 'keyup', saludo, false);
}
function saludo(){
     var url = 'verificarHR.php';
	 var myRand = parseInt(Math.random()*999999999999999);

     var pars = 'codHR='+escape($F('codigo'));
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="1" cellpadding="0">
        <tr>
          ...
          <td width="700">&nbsp;</td>
          <td width="234"><div align="right"><?php echo $_SESSION['sigla']; ?>-<?php echo $_POST['codHR']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </div></td>
        </tr>
      </table></td>
  </tr>
  <tr>
    <td>Codigo:
      <span id="spry_codigoHR">
      <input name="codigo" type="text" id="codigo" value="<?php echo $_SESSION['sigla'];?>-<?php echo $_POST['codHR']; ?>" onkeyup="saludo();" />
      <span class="textfieldRequiredMsg">Se necesita un valor.</span></span>
      <div class="cuadro1" id="muestra-resultado"><span class="Estilo26"><img src="imagen/b_tipp.png" alt="" width="16" height="16" />&nbsp;<span class="Estilo27">Inserte un codigo de Hoja de Ruta.</span></span> Para verificar disponibilidad.<br />
      </div></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><div class="cuadro">
      ...
      <p>Remitente: <span id="spry_remitente">
        ...
        <input name="einterna_id" type="hidden" class="cajas" id="einterna_id" size="5" />
...
<input name="examinar2" type="button" class="botones" id="examinar2" onclick="MM_openBrWindow('insert_correspondenciaRecibidas3.php','Destinatario','status=yes,left=150,top=100,width=730,height=350')" value="BUSCAR" />
</p>
    </div></td>
  </tr>
  <tr>
...
<input name="fecha_derivacion2" type="text" class="cajas" id="fecha_ahora"  value="<?php echo date("d-m-Y H:i"); ?>" size="15" readonly="readonly" />
<input name="fecha_derivacion" type="hidden" class="cajas" id="fecha_derivacion"  value="<?php echo date("Y-m-d H:i:s"); ?>"/></td>
          </tr>
          <tr>
...
<script type="text/javascript">
<!--
var sprytextfield1 = new Spry.Widget.ValidationTextField("spry_codigoHR", "none", {validateOn:["blur", "change"]});
//-->
</script>
</body>
</html>