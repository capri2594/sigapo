...
session_start();
$control=$_SESSION["control_vacio"];
...
*/
//---a este lugar lo movido el punto A
...
//---- punto A
if($control==1)
{ echo '<script>alert("ERROR:\n Seleccione un Rango de Fechas");</script>';
}
else
{ 
  if((empty($_POST['seg_f_destino']))||(empty($_POST['seg_d_destino']))||(empty($_POST['mensaje'])))
  { $_SESSION["control_vacio"]=1;
  }
  else
  { $_SESSION["control_vacio"]=0;
  	echo '<script>alert("ERROR:\n Dato lleno.$cod_dep.");</script>';
  	/*if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
