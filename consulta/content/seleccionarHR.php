...
?>
<?php 
if((isset($_GET['sid']))&&(isset($_GET['rand']))&&($_GET['sid']=$_SESSION['sid'])&&isset($_SESSION['pin'])&&isset($_SESSION['cod'])){
?>
...
<title>Consulta: Hoja de Ruta</title>
<style type="text/css">
<!--
.cuadro {
	color: #7A7A7A;
...
function autentificar()
 {
    ...
    var url = 'ajax/verificar_acceso.php';
	 //alert(url);
...
<script  src="../../content/js/prototype.js" language="javascript1.2"></script>
...
function saludo(){
     var url = '../../content/verificarHRexistente.php';
	 var myRand = parseInt(Math.random()*999999999999999);
...
<link href="../../content/css/autocontempler.css" rel="stylesheet" type="text/css" />
</head>

<body onload="autentificar();document.getElementById('cod').focus();" >
<form action="mostrarHR.php" method="GET" name="formHR" target="_blank" id="formHR">
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="1" cellpadding="2">
            ...
            <tr>
              ...
              <input type="button" name="button" id="button" value="Logout"  onclick="if(confirm('ESta seguro de salir del sistema?')) logout();"/>
              </label></td>
            </tr>
            <tr>
              ...
              <div id="lista_opciones" class="autocomplete" ></div>
                  <script type="text/javascript">
					new Ajax.Autocompleter("cod", "lista_opciones", "../../content/ajax/HRs.php", {
method: "get",
paramName: "texto"});
...
<div class="contenedor"><div id="lista" class="fill"></div></div>              </td>
              <td width="24%" valign="middle"><div align="left">
                <input name="Llenar Hoja de Ruta (2)" type="submit" id="Llenar Hoja de Ruta (2)" onclick="/*if ($F('cod')!='') {MM_openBrWindow('derivarHojaRutaDestinos.php?cod='+$F('cod'),'destinos','width=780,height=450,resizable=yes,scrollbars=yes');}*/" value="Mostrar" />
              </div>
                <label>
                <div align="right">
&nbsp;                </div>
...
<tr>
     ...
     <tr>
       <td><table width="100%" border="0" cellspacing="1" cellpadding="7">
           <tr>
             <td><div class="cuadro" id="muestra-resultado"><span class="Estilo26"><img src="../../content/imagen/b_tipp.png" width="16" height="16" />&nbsp;<span class="Estilo27">Inserte un codigo de Hoja de Ruta.</span></span>(Correspondencia INTERNA de la Prefectura)<br />
             </div></td>
           </tr>
       </table></td>
     </tr>
