...
.new_destino {
	...
	background-image: url(../../content/imagen/usuario02.png);
...
.b_imprimir {
    cursor:hand; cursor:pointer;
	background-image: url(../../content/imagen/hr.gif);
	background-repeat: no-repeat;
	background-position: left center;
	padding-left: 25px;
	width: 75px;
...
.editarHR {
	font-family: Arial, Helvetica, sans-serif;
	background-image: url(../../content/imagen/botones/edit.png);
	background-repeat: no-repeat;
	background-position: left center;
	height: 20px;
	width: 70px;
...
.b_imprimir2 {
    cursor:hand; cursor:pointer;
	background-image: url(../../content/imagen/preview.gif);
	background-repeat: no-repeat;
	background-position: left center;
	margin-left: 0px;
	padding-left: 25px;
...
.b_salir {
    cursor:hand; cursor:pointer;
	background-image: url(../../content/imagen/exit.png);
	background-repeat: no-repeat;
	padding-left: 30px;
	background-position: left center;
	margin-left: 0px;
...
.actualizar {
	cursor:hand; cursor:pointer;
	background-image: url(../../content/imagen/actualizar.png);
	padding-left: 25px;
	background-repeat: no-repeat;
	background-position: left center;
	color: #000000;
...
.eliminar {
	font-family: Arial, Helvetica, sans-serif;
	font-size: 10px;
	background-image: url(../../content/imagen/botones/eliminar_todo.png);
	background-repeat: no-repeat;
	height: 20px;
	width: 20px;
}
.desactivar {
	font-family: Arial, Helvetica, sans-serif;
	font-size: 10px;
	background-image: url(../../content/imagen/botones/vaciar_off.png);
	background-repeat: no-repeat;
	height: 20px;
	width: 20px;
}
.modificar {
	font-family: Arial, Helvetica, sans-serif;
	font-size: 10px;
	background-image: url(../../content/imagen/botones/edit_on.png);
	background-repeat: no-repeat;
	height: 20px;
	width: 20px;
}
...
.barra {
	background-image: url(../../content/imagen/barras/fondo_barra.jpg);
...
.barra_imprimir {
    cursor:hand; cursor:pointer;
	background-image: url(../../content/imagen/barras/icon_impresora.jpg);
	background-repeat:   no-repeat;
	border-top-width: 0px;
	border-right-width: 0px;
	border-bottom-width: 0px;
...
.barra_espacio {
	background-image: url(../../content/imagen/barras/separador.jpg);
	background-repeat:  no-repeat;
}
.tabla_barra {
	margin: 0px;
...
.Estilo19 {background-image: url(../../content/imagen/barras/fondo_barra.jpg); background-repeat: repeat; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-top-style: solid; border-right-style: solid; border-bottom-style: solid; border-left-style: solid; color: #000000; }
.Estilo21 {color: #FFFFFF}
-->
</style>

<script type="text/javascript" src="../../content/js/scriptaculous/prototype.js"></script>
<script type="text/javascript" src="../../content/js/scriptaculous/scriptaculous.js"></script>
...
<script type="text/javascript" src="../../content/js/scriptaculous/unittest.js"></script>
         ...
         <tr>
           <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
             <tr>
               ...
               <td width="5"><img src="../../content/imagen/sombra_pestaña.png" alt="" width="7" height="30" /></td>
               <td width="50">&nbsp;</td>
               </tr>
           </table></td>
         </tr>
    ...
    <td class="td-border-style-4"><table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-style:solid;border-width:0px; margin:0px; padding:0px; border:0px; height:30px; width:100%; ">
      <tr style="height:30px;">
        ...
        <td width="280" height="30" class="barra" style="width:250px;"><span id="sprytextfield1"><span class="barra" style="width:250px;">
          <input name="npag" type="text" id="npag"  maxlength="2" style="width:30px; padding-left:5px;" onkeypress="if(event.keyCode == Event. KEY_RETURN) if(sprytextfield1.validate()){MM_openBrWindow('../../content/imprimir/hoja_ruta/pagina'+$F('npag')+'_5.php?cod=<?php echo $_GET['cod'];?>','pag1','menubar=yes,scrollbars=yes,resizable=yes,width=900,height=700')}else{alert('Error, revise e intente nuevamente.')};"/>
        </span><span class="Estilo19">/10</span> <span class="textfieldRequiredMsg">x.</span><span class="textfieldMaxValueMsg" style="z-index:3; position:relative;">No permitido.</span><span class="textfieldMaxCharsMsg">solo 2 digitos.</span><span class="textfieldMinCharsMsg">x.</span><span class="textfieldInvalidFormatMsg">Formato no válido. </span><span class="textfieldMinValueMsg">NO permitido.</span></span></td>
        <td width="35" height="30" class="barra_imprimir" onclick="if(sprytextfield1.validate()){MM_openBrWindow('../../content/imprimir/hoja_ruta/pagina'+$F('npag')+'_5.php?cod=<?php echo $_GET['cod'];?>','pag1','menubar=yes,scrollbars=yes,resizable=yes,width=900,height=700')}else{alert('Error, revise e intente nuevamente.')}">&nbsp;</td>
        <td class="barra">&nbsp;</td>
        <td width="77" height="30" class="barra"><div class="b_imprimir2" id="button7" onclick="MM_openBrWindow('../../content/imprimir/hoja_ruta/pagina3_5.php?cod=<?php echo $_GET['cod'];?>','pag1','menubar=yes,scrollbars=yes,resizable=yes,width=900,height=700')" title="Ver IMPRIMIR Pag. 3" ><span class="Estilo17">Pag. 3</span></div></td>
        <td width="77" height="30" class="barra"><div class="b_imprimir2" id="button2" onclick="MM_openBrWindow('../../content/imprimir/hoja_ruta/pagina2_5.php?cod=<?php echo $_GET['cod'];?>','pag1','menubar=yes,scrollbars=yes,resizable=yes,width=900,height=700')" title="Ver IMPRIMIR Pag. 2"> <span class="Estilo17" style="vertical-align:middle;">Pag. 2</span></div></td>
        <td width="77" height="30" class="barra"><div class="b_imprimir2" id="button5" onclick="MM_openBrWindow('../../content/imprimir/hoja_ruta/pagina1_5.php?cod=<?php echo $_GET['cod'];?>','pag1','menubar=yes,scrollbars=yes,resizable=yes,width=900,height=700')" title="Ver IMPRIMIR Pag. 1"><span class="Estilo17">Pag. 1</span></div></td>
        <td height="30" class="barra">&nbsp;</td>
        <td width="9" height="30" class="barra_espacio">&nbsp;</td>
        <td width="15" height="30" class="barra">&nbsp;</td>
        <td width="100" height="30" class="barra"><div align="right" class="new_destino" id="button3"  onclick="alert('Uds. es usuario de consulta. LA OPICON ESTA DESHABILITADA')" style="height:30px;" title="AGREGAR NUEVO DESTINO"><span class="Estilo17">Nuevo Destinatario</span> </div></td>
        <td width="15" height="30" class="barra">&nbsp;</td>
        <td width="9" height="30" class="barra_espacio">&nbsp;</td>
        <td width="15" height="30" class="barra">&nbsp;</td>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="3">
      <tr bgcolor="#EDEFF3">
        ...
        <td width="100" height="25">Firma Derivacion</td>
        <td width="70" height="25">Fech.Deriv</td>
        <td width="100" height="25">Acciones</td>
        <td width="70" height="25">Estado</td>
      </tr>
          ...
          <tr class="celdas">
            ...
            <td width="100">&nbsp;</td>
            <td width="70"><img src="../../content/imagen/conformidad_accept.gif" alt="si" width="16" height="16" longdesc="si" /> <span class="Estilo4"><span class="Estilo8">Recibido</span></span></td>
        </tr>
          <?php if ($totalRows_listar_destinos > 0) { // Show if recordset not empty ?>
            ...
            <tr class="celdas">
              ...
              <td width="100"><table width="100%" border="0">
                  <tr bgcolor="#CAD2DB">
                    <td width="30">
                        ...
                        <input name="Modificar" type="button" class="modificar" id="Modificar" onclick="alert('DESHABILITADO');" value="   " alt="Editar o Modificar" title="Editar o Modificar"/>
                      <?php }?>                    </td>
                    <td width="30">
                      <?php if (($row_listar_destinos['entradas_id']<=0)){ ?>
                      <input name="bdesactivar" type="button" class="desactivar" id="bdesactivar" value="   " alt="Desactivar" title="desactivar destino" onclick="alert('DESHABILITADO');"/>
                      <?php }?>                    </td>
                    <td width="30"><?php if (($row_listar_destinos['entradas_id']<=0)&&($row_listar_destinos['nro_destino']==$row_obtener_hr['cont_destinos'])){ ?>
                      <input name="eliminar" type="button" class="eliminar" id="eliminar" value=" " alt="Eliminar" title="Eliminar destino" onclick="alert('DESHABILITADO');"/>
                      <?php }?></td>
                  </tr>
                  <tr>
                    <td width="30">&nbsp;</td>
              ...
              <td width="70"><?php if ($row_listar_destinos['entradas_id']>0){ ?><img src="../../content/imagen/conformidad_accept.gif" alt="si" width="16" height="16" longdesc="si" />
                <span class="Estilo4"><span class="Estilo8">Recibido y Despachado</span>.              </span>
                <?php }else{?><img src="../../content/imagen/conformidad_error.gif" alt="no" width="16" height="16" longdesc="no" /> <span class="pendiente"> Sin conformacion de Recepcion
                </span>
              <?php }?>          <div id="inactivo<?php echo $row_listar_destinos['nro_destino']; ?>">&nbsp;</div></td>
            </tr>
...
<script type="text/javascript">
<!--
var sprytextfield1 = new Spry.Widget.ValidationTextField("sprytextfield1", "integer", {validateOn:["blur", "change"], maxChars:2, minChars:1, hint:"4", minValue:4, maxValue:10, useCharacterMasking:true});
//-->
</script>
</body>
</html>
