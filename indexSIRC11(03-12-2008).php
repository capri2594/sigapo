...
if (isset($_POST['uid'])) {
  ...
  $LoginRS__query=sprintf("SELECT cuenta, clave FROM usuario WHERE cuenta=%s AND clave=%s",
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr class="franja">
    <td height="530">&nbsp;</td>
    <td height="400" valign="top"><form id="form1" name="form1" method="POST" action="<?php echo $loginFormAction; ?>">
    ...
    function conMinuscula(field) {
            field.value = field.value.toLowerCase()
}
</script>

                  <input name="uid" type="text" id="uid" onChange="conMinuscula(this)"/>
                  <span class="textfieldRequiredMsg"> &nbsp;vacio...! </span></span></td>
              </tr>
              <tr>
                <td width="120"><div align="right" class="Estilo1">Clave&nbsp;</div></td>
                <td><span id="sprytextfield2">
                  <input type="password" name="pswd" id="pswd" onChange="conMinuscula(this)"/>
