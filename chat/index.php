...
<html>
  <head>
    <title>Bienvenido a JWChat - the Jabber Web Chat</title>
...
/*<![CDATA[*/
      ...
      background-color: #81addc;
			...
			#about { padding:25px; margin:25px;text-align:left; }
			#featured { padding:25px; margin:25px;text-align:left; }
			#featured div { margin-left: -20px; margin-top: -20px; padding-bottom: 5px; font-size:0.6em; }
  ...
  <body>
            ...
            <table>
                <tr>
                  <td>
                    ...
                    <h2>A web based Jabber/XMPP client</h2>
                  </td>
                </tr>
            </table>
          </td>
    ...
    <form name="login" onSubmit="return loginCheck(this);">
          <table border=0 cellspacing=0 cellpadding=2 id="lTable" align=center width=380>
              ...
              <tr>
                <th class='form_spacer'><label for='jid'>Nombre</label></th>
                <td class='form_spacer' width="100%"><input type="text" id='jid' name="jid" tabindex=3 class='input_text'></td>
              </tr>
              <tr><td>&nbsp;</td><td nowrap class="desc">El Nombre de usuario no debe contener: <span id='chars_prohibited'></span></td></tr>
              <tr>
...
<div id="about">
<h2>What is this?</h2>
This is a web based yet full featured jabber client. Using the form above you can log into any public jabber (xmpp) service.<br/>
...
<ul>
   <li><a href="http://www.billigste-stromanbieter.de/">billigste Stromanbieter</a></li>
   <li><a href="http://www.buero-netshop.de">Büroartikel Büromaterial</a></li>
   <li><a href="http://www.grpoker.com/">Online Poker</a></li>
   <li><a href="http://www.hujambo.de/">Kontaktanzeigen</a></li>
</ul> 
<?php
/* ****************************************************************
...
<tr><td>
    ...
    <tr>
      <td id='td_bottom'>
        ...
        <a href="http://blog.jwchat.org/jwchat/">Download</a> | <a href="http://blog.jwchat.org">Blog</a> | <a href="imprint.html">Imprint</a> 
        <br>
